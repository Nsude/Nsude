...
### **Things I've built**
- [buymeatoken](https:www.buymeatoken.com): The millions of creators in Asia and Africa can't monetize their communities. Buy Me a Coffee doesn't work there. Neither does Patreon or Ko-fi. So I built something that does.
- [Tailwind Class Orgnaiser](https://github.com/Nsude/tailwind-class-organizer): A vscode extension that organizes taiwind classes for improved readability of the classes and entire JSX/TSX/HTML code.
